...
import com.hzy.flume.model.Event;

import java.util.List;
import java.util.Map;

import static com.hzy.flume.interceptor.TimestampInterceptor.Constants.*;
...
public class TimestampInterceptor implements Interceptor {
  ...
  public static class Constants {
    ...
    //preserveExisting  false      If the timestamp already exists, should it be preserved (被保存) - true or false
