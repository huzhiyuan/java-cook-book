...
//import com.hzy.flume.sink.Sink;
//import com.hzy.flume.sink.SinkGroup;
//import com.hzy.flume.sink.SinkGroupConfiguration;
//import com.hzy.flume.sink.SinkRunner;
//import com.hzy.flume.source.Source;
//import com.hzy.flume.source.SourceFactory;
...
//    FlumeConfiguration.AgentConfiguration agentConf = fconfig.getConfigurationFor(getAgentName());
//    if (agentConf != null) {
...
//          }
//        }
//        for (Entry<String, SourceRunner> entry : sourceRunnerMap.entrySet()) {
//          conf.addSourceRunner(entry.getKey(), entry.getValue());
//        }
//        for (Entry<String, SinkRunner> entry : sinkRunnerMap.entrySet()) {
...
//    for (Entry<Class<? extends Channel>, Map<String, Channel>> entry :
...
//  }
//
//  private void loadSinkGroups(FlumeConfiguration.AgentConfiguration agentConf,
