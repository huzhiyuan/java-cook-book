...
import com.hzy.flume.channel.ChannelConfiguration;
import com.hzy.flume.channel.ChannelType;
import com.hzy.flume.common.ComponentConfiguration;
import com.hzy.flume.common.ComponentConfigurationFactory;
import com.hzy.flume.common.constant.BasicConfigurationConstants;
import com.hzy.flume.config.FlumeConfigurationError.ErrorOrWarning;
import com.hzy.flume.exception.ConfigurationException;
import com.hzy.flume.sink.SinkConfiguration;
import com.hzy.flume.sink.SinkGroupConfiguration;
import com.hzy.flume.sink.SinkType;
import com.hzy.flume.source.SourceConfiguration;
import com.hzy.flume.source.SourceType;
    ...
    if (name == null || value == null) {
      errors
          .add(new FlumeConfigurationError("", "",
              ...
              FlumeConfigurationError.ErrorOrWarning.ERROR));
      return false;
    }
          ...
          try {
            conf =
                (ChannelConfiguration) ComponentConfigurationFactory.create(
                    channelName, config, ComponentConfiguration.ComponentType.CHANNEL);
    ...
    private Set<String> validateSources(Set<String> channelSet) {
      ...
      if (sources == null || sources.isEmpty()) {
        ...
        errorList.add(new FlumeConfigurationError(agentName,
            BasicConfigurationConstants.CONFIG_SOURCES,
            FlumeConfigurationErrorType.PROPERTY_VALUE_NULL,
            FlumeConfigurationError.ErrorOrWarning.WARNING));
      ...
      while (iter.hasNext()) {
        ...
        if (srcContext != null) {
          ...
          try {
            ...
            srcConf =
                (SourceConfiguration) ComponentConfigurationFactory.create(
                    sourceName, config, ComponentConfiguration.ComponentType.SOURCE);
            if (srcConf != null) {
          ...
          errorList.add(new FlumeConfigurationError(agentName, sourceName,
              FlumeConfigurationErrorType.CONFIG_ERROR, FlumeConfigurationError.ErrorOrWarning.ERROR));
          ...
          try {
            ...
            sinkConf =
                (SinkConfiguration) ComponentConfigurationFactory.create(
                    sinkName, config, ComponentConfiguration.ComponentType.SINK);
            if (sinkConf != null) {
          ...
          try {
            conf =
                (SinkGroupConfiguration) ComponentConfigurationFactory.create(
                    sinkgroupName, "sinkgroup", ComponentConfiguration.ComponentType.SINKGROUP);
