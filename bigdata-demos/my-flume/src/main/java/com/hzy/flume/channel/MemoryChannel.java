...
import com.hzy.flume.exception.ChannelFullException;
import com.hzy.flume.metric.ChannelCounter;
 ...
 * required.
 * 当对持久化数据没有要求,或者speeds which
 *  * writing to disk is impractical is required
 *  这个时候选择内存channel
 *  另外 单元测试的时候,内存channel也是个好的选择
 */
//@Recyclable
public class MemoryChannel extends BasicChannelSemantics {
  ...
  private static final Integer defaultCapacity = 100;//这个?
  private static final Integer defaultTransCapacity = 100;//事务数量容量?
